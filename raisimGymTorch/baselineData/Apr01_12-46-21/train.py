...
if args.algorithm == 'PPO':
    if not args.model_path:
        ...
        model = PPO(CustomPolicy, env, n_steps=n_steps, gae_lambda=0.975, verbose=0, batch_size=batch_size, n_epochs=4, tensorboard_log=logsPath, gamma=0.9975, clip_range=0.3)
    else:
    ...
    if not args.model_path:
        ...
        model = TRPO(CustomPolicy, env, n_steps=n_steps, gae_lambda=0.975, verbose=0, batch_size=batch_size, tensorboard_log=logsPath, gamma=0.9975)
    else:
