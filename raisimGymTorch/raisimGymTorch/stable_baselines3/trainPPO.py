...
if args.algorithm == 'A2C':
    ...
    if not args.model_path:
        ...
        model = PPO(CustomPolicy, env, n_steps=n_steps, verbose=0, batch_size=batch_size, n_epochs=4, tensorboard_log=logsPath, gamma=0.98, clip_range=0.8, clip_range_vf=0.8)
    else:
